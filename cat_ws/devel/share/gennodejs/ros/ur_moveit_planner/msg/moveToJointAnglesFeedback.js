...
class moveToJointAnglesFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new moveToJointAnglesFeedback(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new moveToJointAnglesFeedback(null);
...
module.exports = moveToJointAnglesFeedback;
