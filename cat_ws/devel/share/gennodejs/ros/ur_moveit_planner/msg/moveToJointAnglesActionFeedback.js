...
let moveToJointAnglesFeedback = require('./moveToJointAnglesFeedback.js');
let actionlib_msgs = _finder('actionlib_msgs');
let std_msgs = _finder('std_msgs');

//-----------------------------------------------------------

class moveToJointAnglesActionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('feedback')) {
        ...
        this.feedback = new moveToJointAnglesFeedback();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = moveToJointAnglesFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new moveToJointAnglesActionFeedback(null);
    ...
    data.feedback = moveToJointAnglesFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new moveToJointAnglesActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = moveToJointAnglesFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new moveToJointAnglesFeedback()
    }
...
module.exports = moveToJointAnglesActionFeedback;
