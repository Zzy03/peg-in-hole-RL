...
class moveToJointAnglesResult {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new moveToJointAnglesResult(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new moveToJointAnglesResult(null);
...
module.exports = moveToJointAnglesResult;
