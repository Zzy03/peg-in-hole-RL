...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'arbotix_python' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/wzc/cat_ws/src/arbotix_ros-indigo-devel/arbotix_python/${idir}'.  Ask the maintainer 'Michael Ferguson <mike@vanadiumlabs.com>' to fix it.")
    endif()
