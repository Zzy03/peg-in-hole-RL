...
if("FALSE" STREQUAL "TRUE")
  set(boost_numpy_SOURCE_PREFIX /home/wzc/cat_ws/src/Boost.NumPy)
...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'boost_numpy' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/wzc/cat_ws/install/${idir}'.  Ask the maintainer 'Kelsey Hawkins <kphawkins@gatech.edu>' to fix it.")
    endif()
