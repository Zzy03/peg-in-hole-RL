...
echo_and_run cd "/home/wzc/cat_ws/src/universal_robot-kinetic-devel/ur_driver"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python" \
    "/home/wzc/cat_ws/src/universal_robot-kinetic-devel/ur_driver/setup.py" \
    build --build-base "/home/wzc/cat_ws/build/universal_robot-kinetic-devel/ur_driver" \
    install \
    $DESTDIR_ARG \
