...
echo_and_run cd "/home/wzc/cat_ws/src/arbotix_ros-indigo-devel/arbotix_sensors"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python" \
    "/home/wzc/cat_ws/src/arbotix_ros-indigo-devel/arbotix_sensors/setup.py" \
    build --build-base "/home/wzc/cat_ws/build/arbotix_ros-indigo-devel/arbotix_sensors" \
    install \
    $DESTDIR_ARG \
