...
echo_and_run cd "/home/wzc/cat_ws/src/arbotix_ros-indigo-devel/arbotix_python"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python" \
    "/home/wzc/cat_ws/src/arbotix_ros-indigo-devel/arbotix_python/setup.py" \
    build --build-base "/home/wzc/cat_ws/build/arbotix_ros-indigo-devel/arbotix_python" \
    install \
    $DESTDIR_ARG \
